...
services=(gateway runtime-controller risk-adapter main-llm-vllm embedding-vllm embedding-ko-vllm risk-prompt-vllm prometheus grafana dcgm-exporter cadvisor loki alloy)
