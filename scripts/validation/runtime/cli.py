...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--risk-base", default=None, help="Risk Signal Service base URL입니다. 우선순위: CLI > RUNTIME_VALIDATION_RISK_BASE_URL > publish 주소.")
    parser.add_argument("--main-llm-base", default=None, help="Main Model Runtime base URL입니다. 우선순위: CLI > RUNTIME_VALIDATION_MAIN_LLM_BASE_URL > publish 주소.")
    ...
    parser.add_argument("--risk-prompt-base", default=None, help="Prompt Injection Detector Runtime base URL입니다. 우선순위: CLI > RUNTIME_VALIDATION_RISK_PROMPT_BASE_URL > publish 주소.")
