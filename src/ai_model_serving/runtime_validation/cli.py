...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--main-llm-base", default=None, help=f"main LLM vLLM OpenAI-compatible base URL입니다. 우선순위: CLI > MAIN_LLM_BASE_URL > 기본값 {DEFAULT_BASE_URLS['main_llm']}.")
    parser.add_argument("--embedding-base", default=None, help=f"embedding vLLM OpenAI-compatible base URL입니다. 우선순위: CLI > EMBEDDING_BASE_URL > 기본값 {DEFAULT_BASE_URLS['embedding']}.")
    parser.add_argument("--risk-prompt-base", default=None, help=f"risk-prompt vLLM OpenAI-compatible base URL입니다. 우선순위: CLI > RISK_PROMPT_BASE_URL > 기본값 {DEFAULT_BASE_URLS['risk_prompt']}.")
    parser.add_argument("--risk-siren-base", default=None, help=f"risk-siren vLLM OpenAI-compatible base URL입니다. 우선순위: CLI > RISK_SIREN_BASE_URL > 기본값 {DEFAULT_BASE_URLS['risk_siren']}.")
