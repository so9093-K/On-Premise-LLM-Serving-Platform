...
REQUIRED_FILES = [
    ...
    'docs/archive/reviews/ux_ui_review.md',
    ...
    'docs/operations/runtime_validation_operations.md',
    ...
    'tests/unit/gateway/test_chat.py',
    'tests/unit/gateway/test_embeddings.py',
    'tests/unit/gateway/test_retrieval.py',
