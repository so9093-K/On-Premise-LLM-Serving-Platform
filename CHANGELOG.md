...
- Main LLM runtime target을 FP8 KV 기반 32K/O3로 정렬했다: `max_model_len=32768`, `max_num_batched_tokens=32768`, `kv_cache_dtype=fp8_e5m2`, `optimization_level=3`. ModelRegistry projection, compose validation, model card, catalog, docs, tests가 같은 runtime policy를 검증한다. ([ADR-0015](docs/adr/0015-main-llm-fp8-kv-32k-o3-runtime-target.md))
